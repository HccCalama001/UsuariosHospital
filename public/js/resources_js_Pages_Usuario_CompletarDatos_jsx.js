...
var CompletarDatos = function CompletarDatos(_ref) {
  ...
  var seguUsuario = (userLogin === null || userLogin === void 0 || (_userLogin$userLogin = userLogin.userLogin) === null || _userLogin$userLogin === void 0 ? void 0 : _userLogin$userLogin.segu_usuario) || {}; // Validar existencia de segu_usuario
  ...
  var _useState5 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(""),
    ...
    setGlobalError = _useState6[1]; // Para manejar errores globales
  ...
  var handleSubmit = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var jwtToken, response, errorData, responseData;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            jwtToken = js_cookie__WEBPACK_IMPORTED_MODULE_1__["default"].get("auth_token");
            if (jwtToken) {
              _context.next = 6;
              break;
            }
            console.error("Token de autenticación no encontrado.");
            setGlobalError("Token no encontrado. Por favor, inicie sesión nuevamente.");
          ...
          case 16:
            ...
            if (response.status === 422) {
              ...
              setGlobalError(errorData.message || "Ocurrió un error inesperado.");
            }
            _context.next = 25;
            break;
          case 20:
          ...
          case 27:
            ...
            console.error("Error inesperado:", _context.t0.message);
            setGlobalError("Error de conexión. Por favor, inténtelo más tarde.");
          case 31:
            _context.prev = 31;
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("h1", {
      ...
      }), globalError && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("div", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)("div", {
          ...
          className: "w-full bg-emerald-600 text-white font-medium py-2 rounded-lg hover:bg-emerald-700 transition duration-200 shadow-md ".concat(isSubmitting ? "opacity-50 cursor-not-allowed" : ""),
